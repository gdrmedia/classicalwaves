...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'paid', 'fulfilled', 'shipped', 'delivered', 'refunded', 'cancelled');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_newsletter_subscribers_source" AS ENUM('footer', 'block', 'checkout', 'other');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('instagram', 'tiktok', 'x', 'facebook', 'pinterest', 'youtube');
  ...
  CREATE TABLE "_products_v_version_variants_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "orders_items" (
  	...
  	"price_at_purchase_cents" numeric NOT NULL
  );
  ...
  CREATE TABLE "orders" (
  	...
  	"shipping_cents" numeric DEFAULT 0 NOT NULL,
  	"tax_cents" numeric DEFAULT 0 NOT NULL,
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"brand_name" varchar DEFAULT 'Classical Waves' NOT NULL,
  	"default_seo_title" varchar,
  	"default_seo_description" varchar,
  	"default_seo_og_image_id" integer,
  	"commerce_free_shipping_threshold_cents" numeric DEFAULT 7500,
  	"commerce_flat_shipping_rate_cents" numeric DEFAULT 800,
  	"commerce_support_email" varchar,
  	"empty_cart_copy" varchar DEFAULT 'Your cart is empty. Start exploring the collection.',
  ...
  ALTER TABLE "_products_v_version_variants_images" ADD CONSTRAINT "_products_v_version_variants_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "_products_v_version_variants_images_order_idx" ON "_products_v_version_variants_images" USING btree ("_order");
  CREATE INDEX "_products_v_version_variants_images_parent_id_idx" ON "_products_v_version_variants_images" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_variants_images_image_idx" ON "_products_v_version_variants_images" USING btree ("image_id");
